...
public class ADMPersistenciaUsuarios {
	...
	public Vector<Usuario> buscarUsuariosParticipantes() throws Exception
	{
		...
		{
			laConexion = DataAccess.Conectar();
			PreparedStatement s = laConexion.prepareStatement("select u.usuario,u.contrasena,u.nombre,u.tipo,u.fechaNacimiento,u.mail,u.estado from usuario u where tipo = 0;");		
